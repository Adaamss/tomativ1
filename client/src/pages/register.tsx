  ...
  const registerMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({
        ...
        description: error.message.includes('409') ? "Un compte avec cet email existe déjà" : "Une erreur est survenue",
        variant: "destructive",
      });
    },
  });
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="flex items-center justify-center mb-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-3xl font-bold text-gray-900" data-testid="text-register-title">
              Inscription
            </h2>
            <p className="mt-2 text-sm text-gray-600">
              Créez votre compte Tomati
            </p>
          </div>
        </div>
