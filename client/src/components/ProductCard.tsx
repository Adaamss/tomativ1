  ...
  return (
    ...
    >
      ...
      <CardContent className="p-3 md:p-5">
        <h4 className="font-bold text-gray-900 mb-2 capitalize text-base md:text-lg leading-tight" data-testid={`text-title-${listing.id}`}>
          {listing.title}
        </h4>
        <p className="text-xl md:text-2xl font-bold mb-2 md:mb-3" style={{ color: '#f14247' }} data-testid={`text-price-${listing.id}`}>
          {formatPrice(listing.price)}
        </p>
        
        <div className="flex items-center text-xs md:text-sm text-gray-600 mb-2 md:mb-3 bg-gray-50 rounded-full px-2 md:px-3 py-1.5 md:py-2">
          <MapPin className="w-3 h-3 md:w-4 md:h-4 mr-1 md:mr-2 text-blue-500" />
