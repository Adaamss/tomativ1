                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center h-full">
                    ...
                    <div className="space-y-6 text-center md:text-left">
                      <div className="space-y-2">
                        <h1 className="text-2xl md:text-3xl lg:text-4xl font-black text-black leading-tight drop-shadow-sm">
                          {slide.title}
                        </h1>
                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-black leading-tight drop-shadow-sm">
                          {slide.subtitle}
                        </h2>
                      </div>
                      <p className="text-base md:text-lg text-gray-900 font-semibold max-w-md mx-auto md:mx-0 drop-shadow-sm">
                        {slide.description}
                      </p>
